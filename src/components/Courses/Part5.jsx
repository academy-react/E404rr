...
const Part5 = () => {
  return (
    ...
    <div className="w-[510px] h-[50px]  border border-transparent mr-[10px] mt-[10px]  relative">
     ...
     <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
       ...
       <input type="checkbox" id='input-one' className='accent-green-800 inline-block  ' />
       <label htmlFor="input-one" className='leading-[70px]'>دوره های به اتمام رسیده</label>
       </div>
       <div className=' mr-[30px]'>
       <input type="checkbox" id='input-two' className='accent-green-600' />
       <label htmlFor="input-two" className='leading-[70px]'>  درحال برگزاری  </label>
   </div>
       </div>
