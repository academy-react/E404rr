...
const Part5 = () => {
  return (
    ...
    <div className="xl:w-auto h-[50px]  border border-transparent xl:mr-[50px] mt-[10px]  relative ">
       <input className="border border-transparent pr-5 npm  caret-green-600  placeholder-green-600 xl:w-[582px] xl:mr-0 mr-3 h-full outline-none rounded-xl w-[300px]  md:w-[400px] lg:w-[650px] " type="search" placeholder="جستوجو دوره های مختلف..." />
