  ...
  return (
    <div className="xl:w-[1250px] h-[70px] w-full bg-[#f3fcf8] xl:mx-auto mt-[70px] border border-transparent flex">
      <div className="xl:w-auto h-[50px]  border border-transparent xl:mr-[50px] mt-[10px]  relative ">
        <input
          className="border border-transparent pr-5 npm  caret-green-600  placeholder-green-600 xl:w-[582px] xl:mr-0 mr-3 h-full outline-none rounded-xl w-[300px]  md:w-[400px] lg:w-[650px] "
          type="search"
      ...
      <div className="flex border border-transparent xl:mr-[220px] mr-2">
        <div className="  xl:mr-[30px] relative ">
          <input
            type="checkbox"
            id="input-one"
            className="accent-green-600 hidden  peer  "
          />
          <label
            htmlFor="input-one"
            className="w-[20px]  h-[20px] border absolute mt-[26px] mr-[-10px] border-green-600  "
          ></label>
          <label
            htmlFor="input-one"
            className="leading-[70px] text-[#323E73]  mr-3"
          >
            دوره های به اتمام رسیده
          </label>
          <label
            htmlFor="input-one"
            className="absolute top-7 right-[-8px] hidden peer-checked:block"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
