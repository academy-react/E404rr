...
import CoursesCard from "../common/CourseCard/CourseCard";
import Pagination from "../Maghalat/Pagination";
      ...
      <div className="flex xl:mx-auto flex-wrap xl:gap-x-[31.75px] xl:gap-y-[62px] lg:gap-[20px] lg:mr-[40px] xl:mr-auto l mt-[92px] border border-transparent  xl:w-[1250px] lg:w-full md:w-[769px] w-[600px] gap-x-3 gap-y-10">
        <div className="w-[287.5px] h-[340px]  rounded last:mb-20   xl:mx-0 lg:mx-0 md:mx-auto ">
          <div className="relative">
            ...
            <select
              id="select"
              className='bg-[#f3fcf8] w-[280px] h-[50px] tracking-[0.060rem] text-[19px] rounded-lg shadow-md  outline-none text-gray-800 pb-2 pr-2 appearance-none after:"hi"'
            >
          ...
          <div className="w-[280px] h-[200px] mt-[41px] rounded-md shadow-lg border border-transparent">
            <div className="mr-[20px] leading-[35px]">
              ...
              <div className="mt-20px relative">
                ...
                <label
                  htmlFor="free"
                  className="border border-green-600 w-[17px] top-[10px] h-[17px] absolute"
                ></label>
                <label
                  htmlFor="free"
                  className=" text-gray-700 text-[17px] mr-5 "
                >
                  رایگان
                </label>
                <label
                  htmlFor="input-one"
                  className="absolute top-[9px] right-[-q6px] hidden peer-checked:block"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <div className="relative">
                ...
                <label
                  htmlFor="cash"
                  className="absolute top-[9px]  hidden peer-checked:block"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
