...
const CoursesLogo = () => {
  return (
    <>
      <div
        className={`${styles.CoursesLogo} max-w-[1366px] mx-auto xl:w-full xl:block hidden md:w-[768px] lg:w-[1024px] xl:h-35 h-[420px] border border-transparent rounded xl:mt-10 mt-5 bg-[#f3fcf8] `}
      >
