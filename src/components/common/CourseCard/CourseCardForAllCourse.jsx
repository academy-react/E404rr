...
import {
  AddDeleteLikeForCourses,
  AddDisLikeForCourses,
  AddLikeForCourses,
} from "../../../core/services/api/CourseAddCourseLike";

const CourseCardForAllCourse = ({
  title,
  desc,
  teacherName,
  cost,
  ...
  return (
    ...
    //         stroke-width="1.5"
    //         stroke="currentColor"
    //         className="w-4 h-4 ml-[110px] cursor-pointer "
    //       >
    //         <path
    //           stroke-linecap="round"
    //           stroke-linejoin="round"
...
<div className="mx-3 mt-3 text-right border border-transparent">
  ...
  <div className=" flex my-3  flex-row-reverse gap-1 items-center border border-transparent w-auto h-auto">
    ...
    <span className="mt-[6px]"> {count2 + dissLikeCount}</span>
