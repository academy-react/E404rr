...
const Item = () => {
  return (
        <>
            <div className="w-[287.5px] h-[340px]  rounded last:mb-20 shadow-md 
             xl:mx-0 lg:mx-0 md:mx-0 hover:scale-110 hover:font-bold transition-all md:max-lg:[&:nth-child(odd)]:mr-[30px] 
                lg:max-xl:[&:nth-child(3n+1)]:mr-[30px]">
              ...
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.75-13a.75.75 0 00-1.5 0v5c0 .414.336.75.75.75h4a.75.75 0 000-1.5h-3.25V5z" clipRule="evenodd" />
                ...
                <time className="text-gray-500 inline-block mr-8 mt-4">07:28:03 </time>
