...
const ArticleBody = () => {
  return (
    <div className=" px-14 flex flex-col py-10 mt-10 rounded-3xl bg-gradient-to-bl from-[#f3fcf8] text-[#323E73] to-white">
      <div className="px-10 flex items-center gap-7 text-2xl mb-7">
      ...
      <div className=" border-2 border-[#ccc] rounded-3xl p-6">
      ...
      <div className="mt-6 flex items-center justify-between border-1 border-t pt-8">
