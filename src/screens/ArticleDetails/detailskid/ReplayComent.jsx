...
import { AddDeleteLikeForCourses, AddDisLikeForCoursesComment, AddLikeForCoursesComment } from '../../../core/services/api/CourseAddCourseLike';

const ReplayComent = ({id , title , describe , author , disslikeCount , likeCount}) => {
  ...
  const handleClick = async () => {
    if (selectedSvg !== 1) {
      ...
      const user = await AddLikeForCoursesComment(id);
    } else {
      setSelectedSvg(null);
      setCount(count - 1);
