...
export default function CourseSharing() {
  return (
    <div className="flex items-center justify-between max-w-[442px] my-14">
      <div className="mr-4">به اشتراک گذاری</div>
      <div className="flex">
        <div className={` mx-3  p-4 rounded-full ${styles.shareItem} `}>
          <svg
            className="w-7"
            viewBox="0 -2 20 20"
            version="1.1"
