        ...
        <div className="flex flex-col md:flex-row lg:gap-16 mx-6">
          <div className="flex flex-col justify-center text-center min-w-[15rem]">
            ...
            <div className="relative">
              <input type="text" placeholder='ایمیل' className='focus:outline-none w-full lg:w-[25rem] mx-2 my-3 px-6 py-2 shadow-md shadow-gray-200 rounded-lg placeholder-darker-green' />
            </div>
            <div className='relative'>
              <input type={passVisible?'text':'password'} placeholder='رمز' className='focus:outline-none w-full lg:w-[25rem] mx-2 my-3 px-6 py-2 shadow-md shadow-gray-200 rounded-lg placeholder-darker-green' />
