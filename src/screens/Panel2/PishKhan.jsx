  ...
  return (
        <>
            <div className='flex flex-wrap border border-transparent mt-[50px] '>
                <div className="w-[240px] h-[84px] bg-yellow-400 border border-transparent rounded-xl mr-[30px] flex items-center ">
                    ...
                    <div className='border border-transparent w-auto h-full text-white mr-[15px] '>
                          <p className='mt-[10px] text-[13px]'>کیف پول</p>
                          <p className='font-bold mt-[5px] text-[18px]'>0 تومان</p>

                    </div>
                </div>
                <div className="w-[240px] h-[84px] bg-blue-400 border border-transparent rounded-xl mr-[30px] flex items-center ">
                    <div className='w-[68px] h-[68px] border border-transparent mr-[5px] rounded-xl bg-white bg-opacity-20 flex items-center justify-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[36px] h-[36px] text-white">
                ...
                <div className="w-[240px] h-[84px] bg-pink-400 border border-transparent rounded-xl mr-[30px] flex items-center ">
                    <div className='w-[68px] h-[68px] border border-transparent mr-[5px] rounded-xl bg-white bg-opacity-20 flex items-center justify-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[36px] h-[36px] text-white">
                    ...
                    <div className='border border-transparent w-auto h-full text-white mr-[15px] '>
                          <p className='mt-[10px] text-[13px]'> مجموع تیکت ها</p>
                          <p className='font-bold mt-[5px] text-[18px]'>0 تیکت</p>

                    </div>
                </div>
                <div className="w-[240px] h-[84px] bg-green-400 border border-transparent rounded-xl mr-[30px] mt-[15px] flex items-center ">
                    <div className='w-[68px] h-[68px] border border-transparent mr-[5px] rounded-xl bg-white bg-opacity-20 flex items-center justify-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[36px] h-[36px] text-white">
