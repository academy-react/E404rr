        ...
        <div className="flex flex-col md:gap:5 lg:gap-12 md:flex-row mx-6">
          <div className="flex flex-col justify-center text-center min-w-[15rem]">
            ...
            <div className="relative">
              <input type="email" placeholder='ایمیل' className='focus:outline-none w-full lg:w-96 mx-2 my-3 px-6 py-2 shadow-md shadow-gray-200 rounded-lg' />
            </div>
            <div className='relative'>
              <input type={passVisible1?'text':'password'} placeholder='رمز' className='focus:outline-none w-full lg:w-[25rem] mx-2 my-3 px-6 py-2 shadow-md shadow-gray-200 rounded-lg' />
            ...
            <div className='relative'>
              <input type={passVisible2?'text':'password'} placeholder='تکرار رمز' className='focus:outline-none w-full lg:w-[25rem] mx-2 my-3 px-6 py-2 shadow-md shadow-gray-200 rounded-lg' />
          ...
          <img src={registerImg} alt="image not found" className='hidden md:scale-75 lg:scale-100 md:block object-fill' />
        </div>
      </div>
    </div>
  )
